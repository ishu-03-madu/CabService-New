                            ...
                            <div class="card car-card h-100">
                                <c:choose>
                                    <c:when test="${not empty car.images}">
                                        <img src="/images/${car.images}" class="card-img-top" alt="${car.name}">
                                    </c:when>
                                    <c:otherwise>
                    ...
                    if (carData.carImages && carData.carImages.length > 0) {
                        ...
                        imagePreview.innerHTML = `
                            <div class="position-relative">
                                <img src="/images/${carData.carImages.trim()}" class="img-thumbnail" style="height: 200px; object-fit: cover;" alt="Car Image">
                            </div>
                        `;
